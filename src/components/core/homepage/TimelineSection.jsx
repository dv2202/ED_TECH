    ...
    <div>
      <div className='flex flex-row gap-15 items-center '>
                    ...
                    timeline.map((element,index)=>{
                        return(
                            <div className='flex flex-row gap-6' key={index}>
                                <div className='w-[50px] h-[50px] bg-white flex items-center justify-center  rounded-full border-white'>
            ...
            <div className='relative shadow-blue-200 w-[55%] '>
                <img src={timelineimg} alt='timelineimg' className='object-cover h-fit bor-timeline'/>
